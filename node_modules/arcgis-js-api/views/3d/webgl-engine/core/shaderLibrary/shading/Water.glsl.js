...
cloudsColor *= clamp(fresnelModifier.y * cloudFresnelModifier[0] - cloudFresnelModifier[1], 0.0, 1.0) * clamp((1.0 - totalFadeInOut), 0.0, 1.0);`),c.hasScreenSpaceReflections?(f.uniforms.add(new d.Matrix4PassUniform("view",((e,o)=>o.ssr.camera.viewMatrix)),new s.Texture2DPassUniform("lastFrameColorTexture",((e,o)=>o.ssr.lastFrameColorTexture)),new i.FloatPassUniform("fadeFactorSSR",((e,o)=>o.ssr.fadeFactor))),f.code.add(n.glsl`vec3 viewDir = normalize(viewPosition);
