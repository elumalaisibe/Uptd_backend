...
*/
define(["exports","../ShaderOutput","../util/RgbaFloatEncoding.glsl","../../shaderModules/interfaces"],(function(t,a,e,l){"use strict";function o(t,o){switch(t.fragment.include(e.RgbaFloatEncoding),o.output){case a.ShaderOutput.Shadow:case a.ShaderOutput.ShadowHighlight:case a.ShaderOutput.ShadowExcludeHighlight:t.fragment.code.add(l.glsl`float _calculateFragDepth(const in float depth) {
