...
define(["exports","../../../../../../chunks/_rollupPluginBabelHelpers","../../../../../../chunks/vec2f64","./PositionAttribute.glsl","../../shaderModules/Float2PassUniform","../../shaderModules/Float3PassUniform","../../shaderModules/Float4sPassUniform","../../shaderModules/FloatsPassUniform","../../shaderModules/interfaces","../../../lib/VertexAttribute","../../../materials/VisualVariablePassParameters"],(function(e,o,i,r,t,a,l,s,v,n,c){"use strict";const f=8;function p(e,o){const i=n.VertexAttribute.FEATUREVALUE;e.attributes.add(i,"vec4");const p=e.vertex;p.code.add(v.glsl`
  ...
  `),p.uniforms.add(new t.Float2PassUniform("size",(e=>e.size))),o.vvSize?(p.uniforms.add(new a.Float3PassUniform("vvSizeMinSize",(e=>e.vvSize.minSize)),new a.Float3PassUniform("vvSizeMaxSize",(e=>e.vvSize.maxSize)),new a.Float3PassUniform("vvSizeOffset",(e=>e.vvSize.offset)),new a.Float3PassUniform("vvSizeFactor",(e=>e.vvSize.factor))),p.code.add(v.glsl`
    vec2 getSize() {
      return size * clamp(vvSizeOffset + ${i}.x * vvSizeFactor, vvSizeMinSize, vvSizeMaxSize).xz;
    }
    `)):p.code.add(v.glsl`vec2 getSize(){
return size;
}`),o.vvOpacity?(p.constants.add("vvOpacityNumber","int",f),p.uniforms.add(new s.FloatsPassUniform("vvOpacityValues",(e=>e.vvOpacity.values),f),new s.FloatsPassUniform("vvOpacityOpacities",(e=>e.vvOpacity.opacityValues),f)),p.code.add(v.glsl`
...
return color;
}`),o.vvColor?(p.constants.add("vvColorNumber","int",c.vvColorNumber),p.uniforms.add(new s.FloatsPassUniform("vvColorValues",(e=>e.vvColor.values),c.vvColorNumber),new l.Float4sPassUniform("vvColorColors",(e=>e.vvColor.colors),c.vvColorNumber)),p.code.add(v.glsl`
    vec4 getColor() {
      float value = ${i}.y;
...
return normal;
}`)}let u=function(e){function r(){var o;return(o=e.apply(this,arguments)||this).size=i.fromValues(1,1),o}return o._inherits(r,e),o._createClass(r)}(c.VisualVariablePassParameters);e.PathVertexPosition=p,e.PathVertexPositionPassParameters=u,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"})}));
