...
*/
define(["exports","../../../../../../chunks/_rollupPluginBabelHelpers","../../../../../../chunks/tslib.es6","../../../../../../chunks/vec3","../../../../../../chunks/vec3f64","../ShaderOutput","../util/DoublePrecision.glsl","../util/View.glsl","../../shaderModules/Float3DrawUniform","../../shaderModules/interfaces","../../shaderTechnique/ShaderTechniqueConfiguration","../../../lib/VertexAttribute","../../../../../webgl/doublePrecisionUtils"],(function(e,r,n,i,t,o,a,s,l,c,u,d,m){"use strict";let v=function(e){function n(){var r;return(r=e.apply(this,arguments)||this).instancedDoublePrecision=!1,r}return r._inherits(n,e),r._createClass(n)}(u.ShaderTechniqueConfiguration);function b(e,r){r.instanced&&r.instancedDoublePrecision&&(e.attributes.add(d.VertexAttribute.MODELORIGINHI,"vec3"),e.attributes.add(d.VertexAttribute.MODELORIGINLO,"vec3"),e.attributes.add(d.VertexAttribute.MODEL,"mat3"),e.attributes.add(d.VertexAttribute.MODELNORMAL,"mat3"));const n=e.vertex;r.instancedDoublePrecision&&(n.include(a.DoublePrecision,r),n.uniforms.add(new l.Float3DrawUniform("viewOriginHi",((e,r)=>m.encodeDoubleHi(i.set(g,r.camera.viewInverseTransposeMatrix[3],r.camera.viewInverseTransposeMatrix[7],r.camera.viewInverseTransposeMatrix[11]),g))),new l.Float3DrawUniform("viewOriginLo",((e,r)=>m.encodeDoubleLo(i.set(g,r.camera.viewInverseTransposeMatrix[3],r.camera.viewInverseTransposeMatrix[7],r.camera.viewInverseTransposeMatrix[11]),g))))),n.code.add(c.glsl`
    vec3 calculateVPos() {
    ...
    `)}n.__decorate([u.parameter()],v.prototype,"instancedDoublePrecision",void 0);const g=t.create();e.InstancedDoubleConfiguration=v,e.InstancedDoublePrecision=b,Object.defineProperty(e,Symbol.toStringTag,{value:"Module"})}));
