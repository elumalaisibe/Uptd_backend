...
*/
define(["exports","./vec3","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderLibrary/output/ReadLinearDepth.glsl","../views/3d/webgl-engine/core/shaderModules/Float2DrawUniform","../views/3d/webgl-engine/core/shaderModules/Float2PassUniform","../views/3d/webgl-engine/core/shaderModules/FloatPassUniform","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DDrawUniform","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform"],(function(e,r,a,o,t,n,l,s,d,i,c){"use strict";const u=4;function f(){const e=new d.ShaderBuilder,f=e.fragment;e.include(a.ScreenSpacePass);const w=(u+1)/2,g=1/(2*w*w);return f.include(o.ReadLinearDepth),f.uniforms.add(new c.Texture2DPassUniform("depthMap",(e=>e.depthTexture)),new i.Texture2DDrawUniform("tex",(e=>e.colorTexture)),new t.Float2DrawUniform("blurSize",(e=>e.blurSize)),new l.FloatPassUniform("projScale",((e,a)=>{const o=r.distance(a.camera.eye,a.camera.center);return o>5e4?Math.max(0,e.projScale-(o-5e4)):e.projScale})),new n.Float2PassUniform("nearFar",((e,r)=>r.camera.nearFar))),f.code.add(s.glsl`
