...
fragColor = color;
	  ...
	  `),r.uniforms.add(new f.Texture2DPassUniform("tex",(e=>e.texture))),a||r.uniforms.add(new d.FloatPassUniform("altitudeFade",(e=>e.altitudeFade))),r.code.add(c.glsl`
		void main() {
			vec4 atmosphereColor = texture(tex, vtc) * falloff;
      ${a?c.glsl`fragColor = atmosphereColor;`:c.glsl`
