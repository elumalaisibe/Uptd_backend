...
}`),w.uniforms.add(new n.FloatPassUniform("perScreenPixelRatio",((e,i)=>i.camera.perScreenPixelRatio))),w.code.add(l.glsl`float planeDistancePixels(vec4 plane, vec3 pos, vec3 start, vec3 end) {
