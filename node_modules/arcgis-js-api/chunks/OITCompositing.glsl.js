...
*/
define(["exports","./_rollupPluginBabelHelpers","../views/3d/webgl-engine/core/shaderLibrary/ScreenSpacePass.glsl","../views/3d/webgl-engine/core/shaderModules/interfaces","../views/3d/webgl-engine/core/shaderModules/ShaderBuilder","../views/3d/webgl-engine/core/shaderModules/Texture2DPassUniform"],(function(e,r,o,t,a,s){"use strict";let n=function(e){function o(){return e.apply(this,arguments)||this}return r._inherits(o,e),r._createClass(o)}(t.NoParameters);function i(){const e=new a.ShaderBuilder;return e.include(o.ScreenSpacePass),e.fragment.uniforms.add(new s.Texture2DPassUniform("colorTexture",(e=>e.colorTexture)),new s.Texture2DPassUniform("alphaTexture",(e=>e.alphaTexture)),new s.Texture2DPassUniform("frontFaceTexture",(e=>e.frontFaceTexture))),e.fragment.code.add(t.glsl`void main() {
